...
CREATE TABLE `hui_attach` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='附件表';
...
CREATE TABLE `hui_config` (
  ...
  KEY `group` (`group`)
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='配置项表';
...
CREATE TABLE `hui_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=706 DEFAULT CHARSET=utf8 COMMENT='系统日志表';
...
INSERT INTO `hui_user` VALUES('27','admin','195e3ea51a813d3806a37eb4ae4e8671','0','2412842937@qq.com','187103665746','1498665763','1516670908','118','127.0.0.1','1','1507627772');
