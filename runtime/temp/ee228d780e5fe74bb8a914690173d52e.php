    ...
    <div class="box">
        ...
        <script type="text/javascript">
            ...
            function showSpeed(){
                ...
                window.opener.document.getElementById("js-wifi").children[1].innerHTML = mb_speed + "M/S";
                window.opener.document.getElementById("js-wifi").style.display = "block";
            }
        </script>
