<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"F:\phpStudy\WWW\Hui.admin\public/../app/admin\view\files\conversion_file.html";i:1517189082;s:67:"F:\phpStudy\WWW\Hui.admin\public/../app/admin\view\public\meta.html";i:1516177545;s:71:"F:\phpStudy\WWW\Hui.admin\public/../app/admin\view\public\redirect.html";i:1516177861;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c">
		<form action="<?php echo url('Files/conversionFile'); ?>" method="post">
	...
	window.onload = function(){ 
		...
		<form action="<?php echo url('Files/conversionDel'); ?>" method="post" id="files-form">
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li class="item" id="tips<?php echo $vo['id']; ?>">
						<div class="portfoliobox">
							...
							<a href="javascript:;" onclick="open_window('<?php echo url('Conversion/preview', ['id' => $vo['id']]); ?>', 900, 700, 0);" title="点击预览">
								<div class="picbox">
									<img src="__ROOT__/images/files/<?php echo $vo['ext']; ?>.png">
								</div>
							</a>
							<div class="textbox f-18">
								<a title="删除" href="javascript:;" onclick="delete_info('<?php echo url('Files/conversionDel',['id'=>$vo['id']]); ?>','转换文件')" data-toggle="tooltip" data-placement="top">
									<i class="Hui-iconfont">&#xe6e2;</i>
								</a>
								<a title="详情" href="javascript:;" class="ml-10" onclick="tips('原文件名称：<?php echo $vo['title']; ?><br>转换文件：<?php echo $vo['name']; ?><br>上传时间：<?php echo $vo['create_time']; ?>','tips<?php echo $vo['id']; ?>')" data-toggle="tooltip" data-placement="top">
									<i class="Hui-iconfont">&#xe695;</i>
								</a>
							</div>
						</div>
